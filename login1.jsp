...
%>
<%
ResultSet rs=stmt.executeQuery("select * from admin where mid='"+a+"'");
while(rs.next())
{
%>
   <html><head>
 <title>e-Resource management system</title>
...
<main id="main01" >
				<center>				
<h2><font color="red">admin record</font></H2>
<h3>
...
<tr><th>aname:</th><td><%= rs.getString(2)%></td></tr>
      
          </table>
		  <br><br>
</h2>
<form action="homepage2.html" method="post">
